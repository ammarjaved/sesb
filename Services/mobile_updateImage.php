...
class Rentis extends Connection
{
	...
	public function upload()
	{
		...
		$query = "INSERT INTO rentis (before_pic1, before_pic2, before_pic3, after_pic1, after_pic2, after_pic3, segment, cycle, vendor,geom) VALUES('$web_des.$before_pic1', '$web_des.$before_pic2', '$web_des.$before_pic3','$web_des.$after_pic1','$web_des.$after_pic2','$web_des.$after_pic3','$segment', '$cycle','$vendor',st_geomfromtext('POINT('||$long||' '||$lat||')',4326))";
